...
class StudentReaderTest {
    ...
    void setup() throws ExecutionException, InterruptedException {
        ...
        // Mockowanie zachowania Firestore
        ...
        // Mockowanie zachowania QuerySnapshot
        when(querySnapshot.getDocuments()).thenReturn(List.of(documentSnapshot1, documentSnapshot2));

        // Mockowanie zachowania QueryDocumentSnapshot
        when(documentSnapshot1.toObject(Student.class)).thenReturn(createStudent("test1@example.com", "Jan", "Kowalski", "123456", true, 1L));
        when(documentSnapshot2.toObject(Student.class)).thenReturn(createStudent("test2@example.com", "Anna", "Nowak", "654321", false, 2L));
    ...
    void testWyswietlWszystkichStudentow() {
        ...
        // Weryfikacja wywołań metody println()
    ...
    private Student createStudent(String email, String imie, String nazwisko, String nr_indeksu, boolean stacjonarny, Long student_id) {
